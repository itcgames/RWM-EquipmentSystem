...
public class PlayerAndGameInfo : MonoBehaviour
{
    public class CharacterInfo
    {
        ...
        public weapon m_weapon1_1 = new weapon("test weapon 1", 0, false);
        public weapon m_weapon1_2 = new weapon("test weapon 2", 0, false);
        public weapon m_weapon1_3 = new weapon("test weapon 3", 0, false);
        public weapon m_weapon1_4 = new weapon("test weapon 4", 0, false);
